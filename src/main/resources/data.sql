...
INSERT INTO gaman_banking.transactions(transaction_id,transaction_date,price,category_name,memo,user_id,delete_flg,created_at,updated_at)
     VALUES (null,CURRENT_TIMESTAMP,300,"お菓子","じゃがりこ",1,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO gaman_banking.transactions(transaction_id,transaction_date,price,category_name,memo,user_id,delete_flg,created_at,updated_at)
     VALUES (null,CURRENT_TIMESTAMP,150,"ジュース","コーラ",1,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO gaman_banking.categorys(id,name,delete_flg,created_at,updated_at)
